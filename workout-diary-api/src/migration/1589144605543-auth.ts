...
export class auth1589144605543 implements MigrationInterface {
    name = 'auth1589144605543'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "user" ADD "deviceId" character varying NOT NULL`, undefined);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "user" DROP COLUMN "deviceId"`, undefined);
